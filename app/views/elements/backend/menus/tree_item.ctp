...
<?php if (empty($data['Menu']['menu_id'])): ?>

    <div id="<?php echo $data['Menu']['id']; ?>" class="menu-item root-item">

    <?php echo $this->Backend->actionLink($data['Menu']['name'] . " &raquo; ", array('controller' => 'menus', 'action' => 'edit', $data['Menu']['id']), array('class' => 'parent_menu', 'escape' => false)); ?>
    <div class="actions">
