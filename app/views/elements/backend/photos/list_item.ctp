<li class="<?php echo $photo['Photo']['published'] ? "published" : "unpublished" ?>">
    <div class="actions">
        ...
        <?php echo $this->Html->link(__('Delete', true), array('controller' => 'photos', 'action' => 'delete', $photo['Photo']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $photo['Photo']['id'])) ?>
        <div class="clear">&nbsp;</div>
    </div>
    <div class="image">
        <div class="image-link-div">
            <?php
            echo $this->Html->link(" ",
                    array('controller' => 'photos', 'action' => 'edit', $photo['Photo']['id']),
                    array(
